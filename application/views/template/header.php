...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="<?= base_url('assets/img/brand/indoaerosemesta.png') ?>" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <i class="ni ni-bullet-list-67 text-red"></i> Kategori Transaksi
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('jurnal_umum') ?>">
            <i class="ni ni-single-copy-04 text-yellow"></i> Tambah Transaksi
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <i class="ni ni-book-bookmark text-yellow"></i> Ringkasan Saldo
            </a>
          </li>
          <li class="nav-item">
