...
class User extends CI_Controller{
    public function __construct(){
        parent::__construct();
        // require APPPATH . 'config/firebase.php';
    ...
    //     $database->getReference('test_connection')->push($testData);

    //     echo "Koneksi ke Firebase berhasil dan data uji coba berhasil ditambahkan!";
    // }
    ...
    // Tentukan jumlah data, jika data kosong set jumlah menjadi 0
    $jumlah = empty($data) ? 0 : count($data);

    // Mengambil data jurnal dan total debit/kredit
    ...
    // Memanggil view dengan semua data yang sudah didefinisikan
...
public function dataAkun(){
    ...
    public function deleteAkun(){
        ...
        if($noReffTransaksi > 0 ){ // Hanya blokir jika ada transaksi terkait
